...
So, for example, the \textit{Fjob} feature will be split into $5$ new features ( \textit{Fjob_teacher}, \textit{Fjob_other}, \textit{Fjob_services}, etc.), and will be assigned a $1$ to one of them and $0$ to all other columns.
